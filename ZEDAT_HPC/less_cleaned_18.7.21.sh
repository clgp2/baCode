...
#SBATCH --job-name=less_cleaned_len140                
#SBATCH --ntasks=1                         
#SBATCH --mem=9G                      
...
path_to_config_file="/home/bernadeta/BA_code/scripts/slurm/config_files/less_cleaned_18.7.21.yaml"
path_to_model_dir="/home/bernadeta/BA_code/models/less_cleaned_18.7.21_len140"
