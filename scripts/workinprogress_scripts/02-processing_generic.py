...
with open("source_input_file_tok") as src_tok_file, open("train.8000.bpe.en", "w") as src_bpefile:
...
count_trg=0
with open("target_input_file_tok") as trg_tok_file, open("train.8000.bpe.ro", "w") as trg_bpefile:
